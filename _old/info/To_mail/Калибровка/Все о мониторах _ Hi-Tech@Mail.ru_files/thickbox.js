...
$(document).ready(function(){   
	...
	tb_init($('.b-content a[href*=/uploads/]:not(.no_thickbox):has(img), .b-content-text a[href*=/uploads/]:not(.no_thickbox):has(img)').addClass('thickbox'));
	//tb_init($('.b-content a:not(.no_thickbox):has(img), .b-content-text a:not(.no_thickbox):has(img)').addClass('thickbox'));
...
// --- shiow/hide flash on overlay show
function showFlash(){
